...
public class PinsetterFrameTen implements Pinsetter{
    ...
    */
    ...
    public void handleThrow(boolean throwAgain, boolean strike) {
        ...
        if ((pinsDownTotal != 10) && (throwNumber == 2 && !tenthFrameStrike)) {
            canThrowAgain = false;
            //publish( lanePublish() );
        }
